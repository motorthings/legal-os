...
const GUIDES: Guide[] = [
  ...
  {
    title: 'Fault-Line Radar — How It Works',
    slug: 'radar-how-it-works',
    desc: 'The four layers legal-AI effect reaches a firm through, the scoring core, the advisory layer that turns a reading into build-priority guidance, and the firm model that answers what is knowable.',
    icon: BarChart3,
    category: 'Fault-Line Radar',
    external: true,
  },
